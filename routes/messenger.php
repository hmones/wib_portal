...
*/
Route::get('/', 'MessagesController@index')->name(config('messenger.path'));
 ...
 */
Route::get('/download/{fileName}', 'MessagesController@download')->name(config('messenger.attachments.route'));
