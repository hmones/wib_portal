...
class EntityFactory extends Factory{
    ...
    public function definition()
    {
        return [
            ...
            "entity_type_id" => $this->faker->numberBetween($min = 1, $max = 6),
            ...
            "primary_country_id" => $this->faker->numberBetween($min = 1, $max = 232),
            "primary_city_id" => $this->faker->numberBetween($min = 1, $max = 12958),
            "primary_postbox" => $this->faker->postcode,
            "primary_postal_code" => $this->faker->postcode,
            "secondary_address" => $this->faker->streetAddress,
            "secondary_country_id" => $this->faker->numberBetween($min = 1, $max = 232),
            "secondary_city_id" => $this->faker->numberBetween($min = 1, $max = 12958),
