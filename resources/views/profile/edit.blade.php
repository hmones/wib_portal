            ...
            <form action="{{route('profile.update',['profile'=>$user])}}" class="ui form" method="POST"
                ...
                <div id="portal_info_form" style="display:none;">
                    ...
                    <div class="ui segment">
                        <div class="field">
                            <div class="ui toggle checkbox">
                                <input type="checkbox" name="mena_diaspora" tabindex="0"
                                       class="hidden" {{$user->mena_diaspora?'checked':''}}>
                    ...
                    <div class="ui segment">
                        <div class="field">
                            <div class="ui toggle checkbox">
                                <input type="checkbox" name="newsletter" tabindex="0"
                                       class="hidden" {{$user->mena_diaspora?'checked':''}}>
                    ...
                    <div class="fields">
                        ...
                        <div class="field">
                            ...
                            <a onclick="$('.ui.modal').modal({inverted: true}).modal('show');"
                               class="ui basic red button">Delete Account</a>
                        </div>
                    </div>
                    <div class="ui basic segment">
