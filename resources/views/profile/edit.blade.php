        ...
        <div class="ui padded basic segment">
            <form action="{{$user->path}}" class="ui form" method="POST" enctype="multipart/form-data" id="user_form">
                ...
                <div id="personal_info_form" style="">
                    ...
                    <a class="ui primary right labeled icon button" onclick="$('#user_submit').trigger('click');">
                        Save Changes
                ...
                <div id="portal_info_form" style="display:none;">
                    ...
                    <div class="ui hidden divider"></div>
                    <a class="ui primary right labeled icon button" id="user_submit">Save Changes <i
