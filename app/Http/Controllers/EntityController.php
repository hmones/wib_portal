...
class EntityController extends Controller
{
    ...
    private $relations = array('Advisory Board Member', 'Board Member', 'Co-Founder', 'Co-Owner', 'Employee', 'Founder',
                               'Manager', 'Member', 'Owner', 'President', 'Professor', 'Student');
    private $business_options = array(
        'balance_sheet' => array('<25Mio', '25Mio-50Mio', '50Mio-100Mio', '100Mio-500Mio', '500Mio-1Bil', '1Bil-3Bil',
                                 '3Bil-5Bil', '5Bil-10Bil', '>10Bil'),
        'revenue'       => array('<25K', '25K-50K', '50K-100K', '100K-500K', '500K-1Mio', '1Mio-3Mio', '3Mio-5Mio',
                                 '5Mio-10Mio', '>10Mio'),
        ...
        'turn_over'     => array('<25K', '25K-50K', '50K-100K', '100K-500K', '500K-1Mio', '1Mio-3Mio', '3Mio-5Mio',
                                 '5Mio-10Mio', '>10Mio'),
        'students'      => array('<200', '201-500', '501-1000', '1001-5000', '5001-10000', '10001-20000', '20001-50000',
                                 '50001-100000', '>100000'),
    );
    ...
    public function update(UpdateEntity $request, Entity $entity, FileStorage $storage, string $slug)
    {
        ...
        $entity->users()->updateExistingPivot(Auth::id(), ['relation_type'   => $data['users']['relation'],
                                                           'relation_active' => 1]);
    ...
    public function associateEntity(Request $request)
    {
        ...
        Auth::user()->entities()->attach($request->other_entity_name, ['relation_type'   => $request->other_entity_relation,
                                                                       'relation_active' => 1]);
    ...
    public function verify(Entity $entity)
    {
        ...
        $approved_at = $entity->approved_at ? null : now();

        $entity->update(compact('approved_at', 'approved_by'));
